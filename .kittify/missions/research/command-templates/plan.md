...
3. **Load context**: Read FEATURE_SPEC and `.kittify/memory/charter.md` if it exists. If the charter file is missing, skip Charter Check and note that it is absent. Load IMPL_PLAN template (already copied).
