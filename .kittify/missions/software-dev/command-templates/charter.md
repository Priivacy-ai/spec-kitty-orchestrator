---
description: Create or update the project charter through interactive phase-based discovery.
---
**Path reference rule:** When you mention directories or files, provide either the absolute path or a path relative to the project root (for example, `kitty-specs/<feature>/tasks/`). Never refer to a folder by name alone.

*Path: [templates/commands/charter.md](templates/commands/charter.md)*
...
This command creates or updates the **project charter** through an interactive, phase-based discovery workflow.

**Location**: `.kittify/memory/charter.md` (project root, not worktrees)
**Scope**: Project-wide principles that apply to ALL features

**Important**: The charter is OPTIONAL. All spec-kitty commands work without it.
...
- Define governance (how the charter changes, who enforces it)
...
Ask the user:
```
Do you want to establish a project charter?

A) No, skip it - I don't need a formal charter
...
Handle responses:
- **A (Skip)**: Create a minimal placeholder at `.kittify/memory/charter.md`:
  - Title + short note: "Charter skipped - not required for spec-kitty usage. Run /spec-kitty.charter anytime to create one."
  - Exit successfully.
...
```
How should the charter be amended?
Examples:
...
```
Who validates that features comply with the charter?
Examples:
...
Here's what will be written to .kittify/memory/charter.md:
...
Proceed with writing charter?
A) Yes, write it
B) No, let me start over
C) Cancel, don't create charter
```

Handle responses:
- **A**: Write the charter file.
- **B**: Restart from Step 1.
- **C**: Exit without writing.

### Step 7: Write Charter File

Generate the charter as Markdown:
...
- Ensure the charter stays lean (1-3 pages, not 10 pages).
